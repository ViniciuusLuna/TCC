<div>
    ...
    <div class="header">
        ...
        <div
            id="panel"
            style="margin-top: 20px; background-color: #4682B4; margin-bottom: 10px;">

            <main>

                <div class="painel">
                    <div class="item-painel" style="height: 40px; width: 100%;">
                        <p>CENTRAL DO ESTUDANTE</p>
                    </div>
                </div>
                <div class="painel">
        ...
        <div id="panel">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div>
                    <select name="materia" style="border-radius: 10px;">
                        <option value="nenhuma diciplina escolhida" selected="selected">Escolha a Materia</option>
    ...
    <div style="margin-top: 20px; margin-bottom: 5px; background-color: #4682B4; color: white;" id="panel">
        <h1 name="perguntas">Perguntas Recentes</h1>
    </div>
...
<?php
    ...
    <div id="panel" style="text-align: left; margin-bottom: 10px; padding: 10px 0px 0px 25px; ">
        <div><h3>
            <a href="?pagina=post&id=<?php echo $id;?>" class="titulo">
                Titulo:
                <?php echo $titulo; ?></a></h3>
        </div>
        
        <div style="padding: 10px;">
            <?php if($descricao != null) {?>
            <p class="descricao" style="color: black;">
                <?php echo $descricao ?></p><?php }?>
        </div>
        <div style="padding: 10px; font-size: 10px; ">
            <p class="descricao" style="color: black; font-size: 15px;">
                Diciplina:
                <?php echo $materia ?></p>
        </div>
...
<?php
        ...
        echo '<li><a href="?pagina=inicio&posts=1" aria-label="Pagina Inicial"><span aria-hidden="true">&laquo;</span></a></li>';
    ...
    for($i = $pg + 1; $i <= $pg + $links; $i++)
        ...
        echo '<li><a href="?pagina=inicio&posts='.$paginas.'" aria-label="Ultima Pagina"><span aria-hidden="true">&raquo;</span></a></li>';
        ?>
</ul>
</nav>
